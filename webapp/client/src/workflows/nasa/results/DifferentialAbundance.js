    ...
    <>
      ...
      // if there are more than 20 plots, show a message to the user
        <span style={{ color: 'red' }} >
          There are {props.result[selectedButton]['plots'].length} plots generated for the {selectedButton} differential abundance analysis. Only the first 20 plots are shown below. Please find all plots in the output directory.
          <br></br>
          <br></br>
        </span>
      )}
